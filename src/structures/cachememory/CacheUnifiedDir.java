...
public class CacheUnifiedDir implements CacheControll{
    ...
    private Hashtable<Integer, Model> cacheMemory = new Hashtable<>();
    ...
    public CacheUnifiedDir(Memory memory,
                           int size,
                           int sizeBlock,
    ...
    public byte[] load(int position){
        ...
        Model model = this.cacheMemory.get(positionBlock);

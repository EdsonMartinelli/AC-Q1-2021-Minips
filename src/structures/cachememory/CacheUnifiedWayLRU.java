...
public class CacheUnifiedWayLRU implements CacheControll{
    public class Model{
        boolean valid;
        boolean isDirty;
        byte[] bytes;
    ...
    private Hashtable<Integer, Set> cacheMemory = new Hashtable<>();
    ...
    public CacheUnifiedWayLRU(Memory memory,
                              int size,
                              int sizeBlock,
                              int ways,
    ...
    public byte[] load(int position){
        ...
        Set set = this.cacheMemory.get(positionSet);
